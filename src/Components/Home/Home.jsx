             ...
             <div class="headerNav hidden md:block">
                    <ul class="flex gap-10 font-semibold">
                        <ul class="md:flex gap-10 hidden font-semibold">
                            ...
                            <li class="hover:border-b-2 hover:border-primary"><a href="Courses.jsx">Courses</a></li>
                            <li class="hover:border-b-2 hover:border-primary"><a href="news.html">News</a></li>
                            <li class="hover:border-b-2 hover:border-primary"><a href="contacts.html">Contact</a></li>
                            <li class="hover:border-b-2 hover:border-primary"><a href="About.html">About us </a>
                            </li>
                        </ul>
                    </ul>
                </div>
         ...
         <section className="theTeam  py-10">
          ...
          <section className="testimonials py-20">
           ...
           <div className="container">
            ...
            <div className="testimonials__wrapper  md:flex gap-40">
              ...
              <div class="my-slider">
                    <div class="flex">
                        ...
                        <img class="w-[770px] h-[250px]" src="https://github.com/kobechode/CCT/blob/master/dist/img/slider-1.png?raw=true" alt=""></img>
                    </div>

                    <div>
                        <img class="w-[770px] h-[250px]" src="https://github.com/kobechode/CCT/blob/master/dist/img/slider2.png?raw=true" alt=""></img>
                    </div>

                    <div>
                        <img class="w-[770px] h-[250px]" src="https://github.com/kobechode/CCT/blob/master/dist/img/slider3.png?raw=true" alt=""></img>
                    </div>
